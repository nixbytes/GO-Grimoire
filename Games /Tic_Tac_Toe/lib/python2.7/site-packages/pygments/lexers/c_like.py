...
class CudaLexer(CLexer):
    ...
    function_qualifiers = set(
        ("__device__", "__global__", "__host__", "__noinline__", "__forceinline__")
    )
    variable_qualifiers = set(
        ("__device__", "__constant__", "__shared__", "__restrict__")
    )
    vector_types = set(
        (
            "char1",
