...
class DockerLexer(RegexLexer):
    ...
    _keywords = r"(?:FROM|MAINTAINER|CMD|EXPOSE|ENV|ADD|ENTRYPOINT|" r"VOLUME|WORKDIR)"
...
class TerraformLexer(RegexLexer):
    ...
    tokens = {
        ...
        "basic": [
            ...
            (
                words(
                    ("variable", "resource", "provider", "provisioner", "module"),
                    prefix=r"\b",
                    suffix=r"\b",
                ),
                Keyword.Reserved,
            ...
            (
                words(
                    ("ingress", "egress", "listener", "default", "connection"),
                    prefix=r"\b",
                    suffix=r"\b",
                ),
                Keyword.Declaration,
