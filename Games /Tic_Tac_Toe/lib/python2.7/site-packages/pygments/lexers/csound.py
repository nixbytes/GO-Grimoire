...
class CsoundLexer(RegexLexer):
    ...
    tokens = {
        ...
        "whitespace or macro call": [include("whitespace"), include("macro call")],
        ...
        "include": [include("whitespace"), (r'"', String, "single-line string")],
        "macro name": [
            include("whitespace"),
            (
                r"(\w+)(\()",
...
class CsoundScoreLexer(CsoundLexer):
    ...
    tokens = {
        ...
        "single-line string": [(r'"', String, "#pop"), (r'[^\\"]+', String)],
    }
...
class CsoundOrchestraLexer(CsoundLexer):
    ...
    tokens = {
        "label": [(r"\b(\w+)(:)", bygroups(Name.Label, Punctuation))],
        "partial expression": [
            include("preprocessor directives"),
            ...
            (
                words(
                    ("goto", "igoto", "kgoto", "rigoto", "tigoto"),
                    prefix=r"\b",
                    suffix=r"\b",
                ),
                Keyword,
            ...
            (
                words(
                    ("cggoto", "cigoto", "cingoto", "ckgoto", "cngoto"),
                    prefix=r"\b",
                    suffix=r"\b",
                ),
                Keyword,
        ...
        "multi-line string": [(r"\}\}", String, "#pop"), (r"[^}]+|\}(?!\})", String)],
        "scoreline opcode": [
            include("whitespace or macro call"),
            (r"\{\{", String, "scoreline"),
            default("#pop"),
