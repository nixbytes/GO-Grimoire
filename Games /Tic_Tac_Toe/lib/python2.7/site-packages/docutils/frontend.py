...
def validate_encoding(
    ...
    try:
        ...
        raise (
            LookupError('setting "%s": unknown encoding: "%s"' % (setting, value)),
            None,
            sys.exc_info()[2],
        )
    return value
...
def validate_boolean(
    ...
    try:
        ...
        raise (
            LookupError('unknown boolean value: "%s"' % value),
            None,
            sys.exc_info()[2],
        )
...
def validate_threshold(
    ...
    try:
        ...
        try:
            ...
            raise (LookupError("unknown threshold: %r." % value), None, sys.exc_info[2])
