...
class SlotDescriptor(object):
    ...
    def __init__(
        self, slot_name, dynamic=False, inherited=False, py3=True, py2=True, ifdef=None
    ):
    ...
    def generate_dynamic_init_code(self, scope, code):
        if self.is_initialised_dynamically:
            ...
            if value != "0":
                code.putln(
                    "%s.%s = %s;"
                    % (scope.parent_type.typeobj_cname, self.slot_name, value)
                )
...
ternaryfunc = Signature(
    "OOO", "O"
)  # typedef PyObject * (*ternaryfunc)(PyObject *, PyObject *, PyObject *);
iternaryfunc = Signature(
    "TOO", "O"
)  # typedef PyObject * (*ternaryfunc)(PyObject *, PyObject *, PyObject *);
callfunc = Signature(
    "T*", "O"
...
PyNumberMethods = (
    ...
    MethodSlot(
        ibinaryfunc, "nb_inplace_divide", "__idiv__", ifdef=PyNumberMethods_Py3_GUARD
    ),
...
slot_table = (
    ...
    MethodSlot(
        hashfunc, "tp_hash", "__hash__", inherited=False
    ...
    MethodSlot(
        richcmpfunc, "tp_richcompare", "__richcmp__", inherited=False
