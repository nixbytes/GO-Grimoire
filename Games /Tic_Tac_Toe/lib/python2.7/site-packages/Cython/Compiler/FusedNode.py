...
class FusedCFuncDefNode(StatListNode):
    ...
    def _buffer_parse_format_string_check(
        ...
        decl_code.putln("{{memviewslice_cname}} {{coerce_from_py_func}}(object)")
    ...
    def make_fused_cpdef(self, orig_py_func, env, is_def):
        ...
        for i, arg in enumerate(self.node.args):
            ...
            if arg.type.is_fused and fused_type not in seen_fused_types:
                ...
                normal_types, buffer_types, pythran_types, has_object_fallback = self._split_fused_types(
                    arg
                )
                ...
                if pyx_code.indenter("while 1:"):
                    ...
                    if buffer_types or pythran_types:
                        ...
                        self._buffer_checks(
                            buffer_types, pythran_types, pyx_code, decl_code, env
                        )
