...
builtin_function_table = (
    [
        ...
        BuiltinFunction("abs", "d", "d", "fabs", is_strict_signature=True),
        BuiltinFunction("abs", "f", "f", "fabsf", is_strict_signature=True),
    ]
    + list(
            ...
            func_type=PyrexTypes.CFuncType(
                ...
                [
                    PyrexTypes.CFuncTypeArg(
                        "arg", getattr(PyrexTypes, "c_{0}_type".format(t)), None
                    )
                ],
...
builtin_types_table = [
    ...
    (
        "slice",
        "PySlice_Type",
        [BuiltinAttribute("start"), BuiltinAttribute("stop"), BuiltinAttribute("step")],
    ),
