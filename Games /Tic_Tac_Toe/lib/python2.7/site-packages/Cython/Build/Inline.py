...
from ..Compiler.ParseTreeTransforms import (
    CythonTransform,
    SkipDeclarations,
...
def cython_inline(
    ...
    **kwds
    ...
    module_name = (
        "_cython_inline_" + hashlib.md5(_unicode(key).encode("utf-8")).hexdigest()
    )
...
%(func_body)s
    return locals()
            ...
            build_extension.extensions = cythonize(
                [extension], include_path=cython_include_dirs or ["."], quiet=quiet
            )
